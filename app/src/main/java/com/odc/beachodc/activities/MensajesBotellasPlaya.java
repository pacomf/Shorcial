...
public class MensajesBotellasPlaya extends FragmentActivity implements ActionBar.TabListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_nuevo:
                Intent intentM = new Intent(this, NuevoMensajeBotellaPlaya.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    if ((ValidacionPlaya.playa != null) && (ValidacionPlaya.playa.nombre != null))
                        return ValidacionPlaya.playa.nombre.toUpperCase(l);
                    else
                        return getString(R.string.title_activity_mensaje_botella).toUpperCase(l);
            }
            return null;
        }
    }
